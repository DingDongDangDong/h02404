...
public class P1ComponentCommon extends JFrame {

	// Note: Textbook Example
	public P1ComponentCommon() {
		...
		b3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// Return Ancestor as Container but you can make it be JFrame
	...
	public static void main(String[] args) {
		P1ComponentCommon frame = new P1ComponentCommon();
	}
}
